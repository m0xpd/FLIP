...
However, I should also confess to a feeling that we have become too ready to turn to soft solutions. There is something wasteful about having a little microcontroller (like Branches' ATMega88) sitting there doing something as simple as implementing (in that case two) Bernoulli Gates, even though it is *definitively the correct solution* for Mutable's commecial product. But I'm not designing for production. So - whilst I could easily have implemented my new Bernoulli Gate on an Atmel device or a PIC or similar, I think there remains something interesting and worthwhile in doing it 'old school'. 

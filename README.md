...
I should make it clear - I have absolutely nothing against the use of microcontrollers and DSP in modular synths. I designed FLIP for pleasure as a deliberate 'break' from playing with software-based systems in the recent development of my [STRACHEY](https://github.com/m0xpd/STRACHEY) sequencer. I wanted something new. I should also confess to a feeling that there is something a little wasteful about having even a simple microcontroller (like Branches' ATMega88) sitting there doing something as simple as implementing (in that case two) Bernoulli Gates. So - whilst I could easily have implemented a Bernoulli Gate aroud an ATMega device or a PIC, I think there remains something interesting in doing it 'old school'. 

I recognise there are some members of the synth DIY community who actively do not like embedded/DSP. I repeat; I'm NOT one of them. But I'm pleased that this project will be accessible to them.

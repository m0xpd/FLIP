...
In the practical circuit, frequency response and slew rate limitations in the op-amp used as the comparator impose a limit when the threshold is placed closer to the top of the sawtooth's range.

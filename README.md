...
I should make it clear - I have absolutely nothing against the use of microcontrollers and DSP in modular synths (as I believe my work proves). I designed FLIP for pleasure as a deliberate 'break' from playing with software-based systems in the recent development of my [STRACHEY](https://github.com/m0xpd/STRACHEY) sequencer. I implemented it in hardware (rather than software) because I wanted the pleasure of something different. 

However, I should also confess to a feeling that we have become a little too ready to turn to soft solutions. There is something a little wasteful about having even a simple microcontroller (like Branches' ATMega88) sitting there doing something as simple as implementing (in that case two) Bernoulli Gates. So - whilst I could easily have implemented my new Bernoulli Gate around an Atmel device or a PIC or similar, I think there remains something interesting and worthwhile in doing it 'old school'. 

I also recognise there are some members of the synth DIY community who actively do not like embedded/DSP. I repeat; **I'm NOT one of them**. But I'm pleased that this project will be accessible to them.

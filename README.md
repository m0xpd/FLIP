...
Flip has two controls: the main 'probability' control and a control for the CV attenuverter. Advancing the probability control clockwise increases the probability that output A will be activated. When a positive CV is applied, advancing the CV attenuverter control clockwise also increases the probability that output A will be activated. 

...
This is only the second project I've developed in KiCad and I'm still feeling my way around. There are two issues on the main board PCB which could be better. The first is the (default, library) footprint for the transistors Q1:3, which has unnecessarily small and close pads. It works, but it asks a lot during the soldering phase! The second is proximity of the 12V line to mounting hole H2 on the bottom of the board; there isn't really enough clearance here for a full washer. Whilst neither of these issues prevent use of the main board PCB as it stands, I will modify both if a "v2" revision is ever made. 

...
This is only the second project I've developed in KiCad and I'm still feeling my way around. The only aspect of the main PCB board which I regret is the (default, library) footprint for the transistors Q1:3, which has unnecessarily small and close pads. It works, but it asks a lot during the soldering phase! I will modify this if a "v2" revision is ever made. 
